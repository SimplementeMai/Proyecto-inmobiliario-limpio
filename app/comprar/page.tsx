...
export default function ComprarPage() {
  ...
  if (loading) return <main className="container mx-auto px-4 py-12">Cargando propiedades en venta...</main>

  return (
    <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <h1 className="text-3xl font-bold mb-2">Propiedades en Venta</h1>
      <p className="text-muted-foreground mb-8">Encuentra tu próximo hogar</p>
      {properties.length === 0 ? (
