...
import { Bed, Bath } from "lucide-react" // Assuming these icons might be used for specs
...
export function PropertyCard({ property }: PropertyCardProps) {
  // Format price to something like $1.5M
    ...
    <Card className="overflow-hidden rounded-xl border-none shadow-sm hover:shadow-md transition-shadow">
      <AspectRatio ratio={4 / 3} className="bg-muted">
        <img
          ...
          alt={`Property image in ${property.location}`} // Dynamic alt text
