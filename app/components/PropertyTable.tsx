...
export function PropertyTable({ properties, userId }: { properties: Property[]; userId?: string | null }) {
  return (
    <div className="rounded-xl border shadow-sm overflow-hidden">
      ...
      <div>
        {properties.map((property) => (
          <PropertyRow key={property.id} property={property} isOwner={property.user_id === userId} />
        ))}
      </div>
    </div>
  )
